    ...
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (boblist.Count > 1)
            {
                ...
                MessageBox.Show("The first element in boblist "+boblist[0]);
            }
            if (jimlist.Count > 1)
            {
                jimlist.RemoveRange(1, jimlist.Count - 1);
                MessageBox.Show("The first element is jimlist " + jimlist[0]);
            }
            if (jacklist.Count > 1)
            {
                jacklist.RemoveRange(1, jacklist.Count - 1);
                MessageBox.Show("The first element in jacklist is " + jacklist[0]);
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
           ...
           /* timer1_Tick.Enabled = true;
            ...
            if (x == Convert.ToInt32(bobarr[8]))
            {
                ...
                MessageBox.Show("Amound remains in Jack account" + jimreduction);
